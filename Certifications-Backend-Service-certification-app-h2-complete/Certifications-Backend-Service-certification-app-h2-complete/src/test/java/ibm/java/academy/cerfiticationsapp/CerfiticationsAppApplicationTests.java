...
class CerfiticationsAppApplicationTests {
	...
	void saveCertificationLengthTest(@Autowired CertificationService certService) {
		Certification certification = new Certification(10004L, "My cert name is too long to save it to my great H2", "https://mycert.com", BigDecimal.valueOf(200), "EUR", State.OPEN);
